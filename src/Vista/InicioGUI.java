...
public class InicioGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("CONECTARSE (INFO)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null, "Información: Haciendo uso de Hibernate, no es necesario indicar al programa mediante un comando"
                + " que debe conectarse a la base de datos. Esto viene implícito en la configuración de Hibernate"
                , "Acción no necesaria", JOptionPane.INFORMATION_MESSAGE);
